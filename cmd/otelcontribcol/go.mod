...
require (
	...
	// github.com/open-telemetry/opentelemetry-collector-contrib/exporter/opencen-contrib/exportersusexporter v0.85.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/vmonitorexporter v0.85.0
